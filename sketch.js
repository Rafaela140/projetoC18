...
//crie uma tela
paredeDireita= createSprite(windowWidth-120,windowHeight,10,800);
paredeEsquerda= createSprite(120,windowHeight,10,800);
...
function draw() {
  ...
  paredeDireita=createEdgeSprites();
  boy.collide(edges);
  boy.collide(paredeDireita);
